...
namespace Солнечная_система
{
    public partial class Form1 : Form
    {
        ...
        private void солнце_CheckedChanged(object sender, EventArgs e)
        {
            Refresh();
        }

        private void луна_CheckedChanged(object sender, EventArgs e)
        {
            Refresh();
        }

        private void сатурн_CheckedChanged(object sender, EventArgs e)
        {
            Refresh();
        }

        private void комета_CheckedChanged(object sender, EventArgs e)
        {
            Refresh();
        }
    }
